...
#pragma HLS PIPELINE II=1
						...
						switch(mode)
						{
							case 0:{sum+=feature_in[h*CHin*Win+w*CHin+c];break;}   //mean pooling
							case 1:{sum=min(sum,feature_in[h*CHin*Win+w*CHin+c]);break;}   //min pooling
							case 2:{sum=max(sum,feature_in[h*CHin*Win+w*CHin+c]);break;}   //max pooling
							default:break;
						}
					}
				if(mode==0)
